...
const CONFIG: Config = {
  ...
  RATE_LIMITER_DURATION_LLM_PRIVATE: Number(getOptionalProcessEnv('RATE_LIMITER_DURATION_LLM_PRIVATE', '60')),
  RATE_LIMITER_DURATION_LLM_PUBLIC: Number(getOptionalProcessEnv('RATE_LIMITER_DURATION_LLM_PUBLIC', '60')),
  RATE_LIMITER_POINTS_LLM_PRIVATE: Number(getOptionalProcessEnv('RATE_LIMITER_POINTS_LLM_PRIVATE', '5')),
  RATE_LIMITER_POINTS_LLM_PUBLIC: Number(getOptionalProcessEnv('RATE_LIMITER_POINTS_LLM_PUBLIC', '5')),
