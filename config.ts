...
const CONFIG: Config = {
  ...
  API_MAX_CONTENT_LENGTH_BYTES:
    Number(getOptionalProcessEnv('API_MAX_CONTENT_LENGTH_BYTES')) || null,
  ...
  FUNCTION_LAMBDA_SECRET_ACCESS_KEY:
    getOptionalProcessEnv('FUNCTION_LAMBDA_SECRET_ACCESS_KEY') ?? '',
  ...
  ML_GATEWAY_SERVICE_HOST: getOptionalProcessEnv('ML_GATEWAY_SERVICE_HOST'),
  ...
  RATE_LIMITER_DURATION_PRIVATE: Number(
    getOptionalProcessEnv('RATE_LIMITER_DURATION_PRIVATE', '60')
  ),

  RATE_LIMITER_DURATION_LLM: Number(
    getOptionalProcessEnv('RATE_LIMITER_DURATION_LLM_PRIVATE', '60')
  ),
  RATE_LIMITER_POINTS_LLM: Number(getOptionalProcessEnv('RATE_LIMITER_POINTS_LLM_PRIVATE', '10')),

  RATE_LIMITER_DURATION_INFERENCE: Number(
    getOptionalProcessEnv('RATE_LIMITER_DURATION_INFERENCE_PRIVATE', '60')
  ),
  RATE_LIMITER_POINTS_INFERENCE: Number(
    getOptionalProcessEnv('RATE_LIMITER_POINTS_INFERENCE_PRIVATE', '10')
  ),
