...
const CONFIG: Config = {
  ...
  IDENTITY_API_SERVICE_URI: getOptionalProcessEnv('IDENTITY_API_SERVICE_URI'),
  IDENTITY_API_SERVICE_PORT_APP: getOptionalProcessEnv('IDENTITY_API_SERVICE_PORT_APP'),
