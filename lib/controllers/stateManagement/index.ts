...
class StateManagementController extends AbstractController {
  ...
  @validate({
    HEADERS_PROJECT: VALIDATIONS.HEADERS.PROJECT_ID,
    HEADERS_VERSION: VALIDATIONS.HEADERS.VERSION_ID,
  ...
  @validate({ HEADERS_PROJECT: VALIDATIONS.HEADERS.PROJECT_ID })
  ...
  @validate({ BODY_UPDATE_SESSION: VALIDATIONS.BODY.UPDATE_SESSION, HEADERS_PROJECT: VALIDATIONS.HEADERS.PROJECT_ID })
  ...
  @validate({ HEADERS_PROJECT: VALIDATIONS.HEADERS.PROJECT_ID, HEADERS_VERSION: VALIDATIONS.HEADERS.VERSION_ID })
  ...
  @validate({ BODY_UPDATE_VARIABLES: VALIDATIONS.BODY.OBJECT, HEADERS_PROJECT: VALIDATIONS.HEADERS.PROJECT_ID })
